    ...
    <footer class="footer container">
      <div class="footer__container grid">
        <div class="footer__content">
          ...
          <p class="footer__description"><span>Phone:</span> 7777777777</p>

          <p class="footer__description"><span>Hours:</span> 10P:00 - 18:00, Mon - Sat</p>
      ...
      <div class="footer__bottom">
        <p class="copyright">©2024 - Dream On</p>
        <span class="designer">Designed by f1shermanloxen (LTD)</span>
      </div>
    </footer>
